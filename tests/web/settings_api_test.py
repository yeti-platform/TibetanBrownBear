...
def test_get_vocab():
    ...
    rv = client.get('/api/settings/vocabs/malware-label-ov/',
...
def test_add_value_to_vocab():
    ...
    rv = client.put('/api/settings/vocabs/malware-label-ov/',
...
def test_remove_value_from_vocab():
    ...
    rv = client.delete('/api/settings/vocabs/malware-label-ov/',
